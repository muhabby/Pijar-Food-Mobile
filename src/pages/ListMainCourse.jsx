...
import {listMainCourse} from '../redux/action/menu';

const ListMainCourse = ({route, navigation}) => {
  const dispatch = useDispatch();
  const menuData = useSelector(state => state.menu_search);
  ...
  return (
    <View style={styles.body}>
      ...
      {/* Card Recipes */}
      {menuData?.isSuccess && menuData?.data ? (
